...
<div class="modal fade" id="subkriteria{{$item->id}}">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="{{route('subkriteria.update',$item->id)}}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$item->bobot}}" id="bobot" name="bobot" required>
                        </div>
